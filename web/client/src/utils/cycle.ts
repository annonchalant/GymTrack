...
import type { CyclePrefs } from "@/utils/cycle-storage";
...
// Custom exercises (added via UI) are arbitrary strings outside this tuple,
// so we keep `Exercise` as `string` for ease.
