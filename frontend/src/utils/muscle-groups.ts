...
// site via `buildExerciseMuscleLookup`.

import { EXERCISES } from "@/src/utils/cycle";
...
// Backwards-compat re-export so any caller still using the old name keeps
// working. (Not strictly needed; kept to avoid mass renames.)
